...
<html>
<head>
<title>Gravity | Pages | Sidebar Left</title>
<meta charset="utf-8">
...
<div class="wrapper row3">
  <main class="container clear"> 
    ...
    <div class="content_three_quarter first"> 
      <table class="table">
      	<tr>
      	  <td colspan="2">
      	...
      	<tr>
      		<th width=20% align=center>주소</th>
      		<td width=80%><%=vo.getAddress() %></td>
      	</tr>
      	<tr>
      		<th width=20% align=center>전화</th>
      		<td width=80%><%=vo.getTel() %></td>
      	</tr>
      	<tr>
      		<th width=20% align=center>음식종류</th>
      	...
      	<tr>
      		<th width=20% align=center>영업시간</th>
      		<td width=80%><%=vo.getTime() %></td>
      	</tr>
      	<tr>
      		<th width=20% align=center>주차</th>
      		<td width=80%><%=vo.getParking() %></td>
      	</tr>
      	<tr>
      		<th width=20% align="center">메뉴</th>
      		<td width=80%>
      			<ul>
      				<%
