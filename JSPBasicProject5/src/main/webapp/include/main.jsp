...
<%--
          ...
          Cookie
          	...
          	2. 저장위치 지정
          	   cookie.setPath("/")
          	3. 저장 기간
          	   cookie.setMaxAge(60*60*24) // 하루 (초단위로 저장)
          	4. 브라우저 전송
          	...
          	7. 사용처 => 최근 방문, 장바구니, 자동 로그인
          	   로그인 (스프링) => 암호화, 복호화, 자동로그인, ID저장
          	   1차 프로젝트 : 웹 흐름파악(송수신), 데이터베이스 연결, 내장객체 사용방법, 화면UI, MVC의 사용법
          	   2차 프로젝트 : Spring => 라이브러리 사용법, Restful(JSON=>Vue)
          Session
          1. 저장
