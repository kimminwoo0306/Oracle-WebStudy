<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	DataBoardVO vo=dao.databoardUpdateData(Integer.parseInt(no)); // no, name, subject, content
%> 
<!DOCTYPE html>
<html>
<head>
	...
	<div class="row row1">
		...
		<table class="table">
			...
			<tr>
				...
				<td width=85%>
					<textarea rows="10" cols="50" name=content required><%=vo.getSubject() %></textarea>
				</td>
			</tr>
			<tr>
