...
<%
	...
	// 각 JSP마다 request를 가지고 있다 => 보내는 JSP에서 한글변환 => form => action GET은 특별한 경우가 아니면 한글을 보내지 못한다
	// GET은 window 10에서는 자동처리
	// POST방식은 한글 처리가 안된다 request.setCharacterEncoding("UTF-8");
	...
	// new DefaultFileRenamePolicy() => 같은 파일명일때 파일명 변경
	// 업로드 완료
	// 데이터베이스에 저장
	...
	String filename=mr.getFilesystemName("upload");// 변경된 파일명
