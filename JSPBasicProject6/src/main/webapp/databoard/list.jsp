...
<%
	...
	//3. 출력 => HTML
	// *** 데이터를 자바에서 읽은 다음에 출력 (자바는 데이터관리) => HTML은 가지고 온 데이터를 출력만한다(정적페이지) JSP (동적페이지)
	// 총 페이지 받기
...
<body>
	<div class="row row1">
		...
		<table class="table">
			<tr>
				<td>
					<a href="../main/main.jsp?mode=7" class="btn btn-sm btn-danger">글쓰기</a><%--btn-danger(red), btn-success(green), btn-info(cyan), btn-primary(blue), btn-warning(orange) --%>
				</td>
			</tr>
		</table>
		<table class="table">
