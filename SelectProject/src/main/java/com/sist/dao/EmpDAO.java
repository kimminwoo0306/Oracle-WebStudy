 ...
 *   ~VO, ~DTO => 데이터를 모아서 전송할 목적 (브라우저, 자바)
 ...
 * 		 PreparedStatement : SQL문장을 먼저 전송, 나중에 값을 채워주는 역할
 * 		 CallableStatement : PL/SQL => 오라클 함수 (프로시저)를 호출할때 사용
...
public class EmpDAO {
	...
	// 1-1 싱글턴패턴 ==> newInstance(), getInstance() => 자바에서 나오면 싱글턴이다
