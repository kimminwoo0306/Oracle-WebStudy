	...
	<div class="wrapper row1">
		<header id="header" class="clear">
			<div id="logo" class="fl_left">
				<h1>
					<a href="index.html">서울 맛집 & 서울 여행</a>
				</h1>
			</div>
			<div class="fl_right">
				<!-- 로그인이 안된 상태 -->
				<c:if test="${sessionScope.id==null }">
					<ul class="inline">
						<li>ID<input type="text" name=id size=10 class="input-sm"
							placeholder="ID" id="log_id"></li>
						<li>PW<input type="password" name=pwd size=10
							class="input-sm" placeholder="Password" id="log_pwd"></li>
						<li><input type="button" class="btn btn-lg btn-danger"
							value="로그인" id="logBtn"></li>
					</ul>
				</c:if>
				...
				<c:if test="${sessionScope.id!=null }">
					<ul class="inline">
						<li>${sessionScope.name }(${sessionScope.admin=='y'?"관리자":"일반사용자" })님
							로그인중입니다</li>
						<li><input type="button" class="btn btn-lg btn-primary"
							value="로그아웃" id="logoutBtn"></li>
					</ul>
				</c:if>
			</div>
		</header>
	...
	<div class="wrapper row2">
		<nav id="mainav" class="clear">
			<ul class="clear">
				...
				<li><a class="drop" href="#">회원</a> <c:if
