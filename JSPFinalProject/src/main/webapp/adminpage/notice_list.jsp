  ...
  <main class="container clear">
    ...
    <div style="height: 550px">
    	<table class="table">
    		<tr>
    			<td>
    				<a href="../adminpage/notice_insert.do" class="btn btn-sm btn-danger">새글</a>
    			</td>
    		</tr>
    	</table>
    	<table class="table">
    	 ...
    	 <c:forEach var="vo" items="${list }"> <%-- request.setAttribute("list", list)  => request.getAttribute("list") == ${list }--%>
    	 	<tr>
    	 		...
    	 		<a href="../notice/detail.do?no=${vo.no }">${vo.subject } &nbsp;
    	 		...
    	 		<td width="15%" class="text-center">
    	 		  ...
    	 		  <a href="../adminpage/notice_delete.do?no=${vo.no }" class="btn btn-xs btn-info">삭제</span>
    	 		</td>
    	 	</tr>
    	 </c:forEach>
    	</table>
