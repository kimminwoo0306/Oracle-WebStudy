...
<div class="wrapper row3">
  ...
  <table class="table">
   <tr>
     <td class="text-center"><img src="${vo.poster }" style="width:800px;height: 350px"></td>
   </tr>
   <tr>
...
function removeAllChildNods(el) {   
    ...
    <div class="flexslider carousel basiccarousel btmspace-80">
      <ul class="slides">
        <c:forEach var="fvo" items="${list }" varStatus="s"><%-- list의  index번호 --%>
	        <li>
	          <figure><img class="radius-10 btmspace-10" src="${fvo.poster }" title="${fvo.type }">
    ...
    <div class="sidebar one_quarter">
	  <h2 class="sectiontitle">인기명소 Top5</h2>
	</div>
