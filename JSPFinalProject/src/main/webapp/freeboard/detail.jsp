   ...
   <div class="wrapper row3">
      <main class="container clear">
         ...
         <table class="table">
            ...
            <tr>
               <td class="text-left" valign="top" colspan="4" height="200"><pre
                     style="white-space: pre-wrap; background-color: white; border: none;">${vo.content }</pre></td>
            </tr>
            <tr>
               <td class="text-right" colspan="4"><a
                  href="../freeboard/update.do?no=${vo.no }"
                  class="btn btn-xs btn-success">수정</a> <span
                  class="btn btn-xs btn-warning" id="delete">삭제</span> <a
                  href="../freeboard/list.do" class="btn btn-xs btn-info">목록</a></td>
            </tr>
         ...
         <h3 class="sectiontitle">인기게시물 Top5</h3>
         </div>
      </main>
   </div>
</body>
