...
SELECT LAST_DAY('22/08/01') FROM DUAL;
...
/*
     변환 
       ******* TO_CHAR  : 문자열 변환 
       TO_DATE  : 날짜형 변경
       TO_NUMBER : 숫자형 변경  TO_NUMBER('10')+10 => 20 TO_NUMBER('AA')
*/
SELECT TO_NUMBER('100')+TO_NUMBER('200') FROM DUAL;
SELECT '100'+'200' FROM DUAL;
-- 주문일 
SELECT TO_DATE(SYSDATE,'YYYY-MM-DD')+5 이전,
       TO_DATE(SYSDATE,'YYYY-MM-DD')-5 이후
FROM DUAL;
-- TO_CHAR 
/*
