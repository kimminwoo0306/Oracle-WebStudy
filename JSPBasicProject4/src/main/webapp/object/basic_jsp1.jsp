<!--  
		...
		1) 내부객체
		  ...
		  public void _jspService(final javax.servlet.http.HttpServeletRequest request, final javax.servlet.http.Httpservlet
		  {
			...
			= 기능
			  ...
			  2. 요청 관련 정보
			      ...
			      = 브라우저 ==> Java(2byte)
			      	...
			      	Java(2byte) ==> 브라우저
			      	            2byte => 1byte로 변경 (인코딩)
			      	https://www.google.co.kr/search?q=%EC%9E%90%EB%B0%94&sxsrf=AJOqlzXOYk5iL23kANsfQ8Ewqe_mSBc6Kw%3A1673224577312&source=hp&ei=gWG7Y5yKEYfK-Qb10ILwDA&iflsig=AK50M_UAAAAAY7tvkcTJExaHlcJIkzV9JYxyBorJhcDy&ved=0ahUKEwjczrukn7n8AhUHZd4KHXWoAM4Q4dUDCAo&uact=5&oq=%EC%9E%90%EB%B0%94&gs_lcp=Cgdnd3Mtd2l6EAMyBAgjECcyBAgjECcyBAgjECcyCwgAEIAEELEDEIMBMggIABCABBCxAzIICAAQgAQQsQMyBQgAEIAEMgUIABCABDIFCAAQgAQyCAgAEIAEELEDOhEILhCABBCxAxCDARDHARDRAzoECAAQAzoLCC4QgAQQsQMQgwE6BwguENQCEANQAFj3AWC9A2gAcAB4AIABnwKIAccFkgEFMC4xLjKYAQCgAQE&sclient=gws-wiz
			      	브라우저로 전송
			      ...
			      *** 데이터 전송
			          ...
			          a.jsp?hobby=a&hobby=b&hobby=c
			                ------------------------
			                Strint[] request.getParameterValues("hobby")
			           3) 추가 기능 => 사용자 보내준 데이터 + 필요한 데이터를 추가해서 전송 (MVC, Spring)
			...
			<table class="table">
				...
				<tr>
					...
					<td width=80%>
						...
						<input type="checkbox" value="낚시" name=hobby>낚씨
						<input type="checkbox" value="독서" name=hobby>독서
						<%-- 전송값 : value, name은 동일해야 된다 : Strint[] getParameterValues("hobby") --%>
					</td>
				</tr>
				<tr>
