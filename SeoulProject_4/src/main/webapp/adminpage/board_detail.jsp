  ...
  <main class="container clear" style="width:80%;position:relative;left:20px;">
    ...
    <table class="table">
    	...
    	<tr>
    		...
    		<a href="../adminpage/update.do?bno=${vo.bno }" class="whitegray_btn">수정</a>
    		<a href="../adminpage/board_delete.do?no=${vo.bno }" class="whitegray_btn" >삭제</a>
    		</c:if>
    		</c:if>
    		<a href="../adminpage/board_list.do" class="whitegray_btn">목록</a>
    		</td>
    	</tr>
